...
var handleCheckout = async (req, res) => {
    try{
        ...
        if(customerId === "empty"){
            ...
            //render with additional button
            var last4 = await customer.retrieveCard(customerId);
...
var handleNewCharge = async (req, res) => {
    try{
        ...
        if (existingCustomerId === "empty"){
            ...
            var save_customer_status = await customer.saveCustomerId(stripe_customer);
        }
